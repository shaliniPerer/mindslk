...
import { Home, Trees, Droplets, BedDouble, Hammer, MapPin } from 'lucide-react';

const galleryImages = [
  '/MInds Photos/MINDS to send/Y1.jpg',
  '/MInds Photos/MINDS to send/Y2.jpg',
  '/MInds Photos/MINDS to send/Y3.jpg',
  '/MInds Photos/MINDS to send/Y4.jpg',
  '/MInds Photos/MINDS to send/Y5.jpg',
  '/MInds Photos/MINDS to send/Y6.jpg',
  '/MInds Photos/MINDS to send/Y7.jpg',
  '/MInds Photos/MINDS to send/Y8.jpg',
];
...
const features = [
  {
    ...
    desc: 'A 387 sqft bedroom area complemented by a 207 sqft cozy attic retreat.',
  },
  {
    icon: <Trees className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Private Balcony',
    desc: 'A spacious 208 sqft balcony overlooking the courtyards or lush greenery.',
  },
  {
    icon: <Droplets className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Nature-Infused Bathroom',
    desc: 'A 141 sqft en-suite bathroom featuring a dedicated foliage area and a glass roof.',
  },
  {
    icon: <BedDouble className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Versatile Bedding',
    desc: 'Can be converted into a triple bedroom (1 double bed + 1 single bed) upon request.',
  },
  {
    icon: <Hammer className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Architectural Detail',
    desc: 'Features hand-carved timber and traditional design elements inspired by the Kandyan period.',
  },
  {
    icon: <MapPin className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Prime Location',
    desc: 'Located on the first floor with easy access to the pool area and resort grounds.',
  },
];
    ...
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      <section className="relative h-[55vh] min-h-[420px] w-full overflow-hidden flex items-center justify-center text-white">
        <div className="absolute inset-0 z-0">
          <Image
            src="/MInds Photos/MINDS to send/X10.jpg"
            alt="Deluxe Room"
            fill
            priority
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <span className="text-[10px] uppercase tracking-[0.5em] font-bold text-[#D4A044]">The Heritage Attic Experience</span>
            <div className="h-[1px] w-10 bg-[#D4A044]" />
          </div>
          <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight">Deluxe Room</h1>
        </motion.div>
      </section>
          ...
          <div className="lg:col-span-2 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[#001F3D]/70 text-sm leading-relaxed">
                Our Deluxe Rooms are located on the first floor and offer a unique, multi-level living experience. These rooms are perfect for those who appreciate elevated views and traditional timber detailing.
              </p>
            </div>
            ...
            >
              <div>
                ...
                <div className="flex items-baseline gap-1 mt-2">
                  <span className="text-3xl font-serif font-bold text-[#D4A044]">$250</span>
              ...
              <div className="flex flex-col gap-3 border-t border-gray-100 pt-4">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-bold text-[#1B4F8A]">3 Adults</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-[#001F3D]/60">Size:</span>
                  <span className="font-bold text-[#001F3D]">594 sqft</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-[#001F3D]/60">View:</span>
                  <span className="font-bold text-[#1B4F8A]">Courtyard / Greenery</span>
                </div>
              </div>
      ...
      <section className="py-20 px-6 bg-[#FAF9F6]">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
            {[
              { title: 'Deluxe Superior', image: '/MInds Photos/MINDS to send/X20.jpg', href: '/accommodations/deluxe-superior' },
