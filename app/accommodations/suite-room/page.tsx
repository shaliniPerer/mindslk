...
import { Home, Trees, Droplets, ShieldCheck, MapPin, ArrowRight } from 'lucide-react';

const galleryImages = [
  '/MInds Photos/MINDS to send/Y10.jpg',
  '/MInds Photos/MINDS to send/Y11.jpg',
  '/MInds Photos/MINDS to send/Y12.jpg',
  '/MInds Photos/MINDS to send/Y13.jpg',
  '/MInds Photos/MINDS to send/Y14.jpg',
  '/MInds Photos/MINDS to send/Y15.jpg',
  '/MInds Photos/MINDS to send/Y16.jpg',
  '/MInds Photos/MINDS to send/Y17.jpg',
];
...
const features = [
  {
    ...
    desc: 'A 337 sqft area designed with wider doorways and modified furniture for effortless movement.',
  },
  {
    icon: <Droplets className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Luxury Spa Bathroom',
    desc: 'A massive 266 sqft bathroom featuring a private Jacuzzi and a sky-light for ultimate relaxation.',
  },
  {
    icon: <Trees className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Private Garden',
    desc: 'Direct access to a 153 sqft private garden area, where large windows open to let in the fresh breeze.',
  },
  {
    icon: <ShieldCheck className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Full Accessibility',
    desc: 'Equipped with support rails, lowered sinks, and a wide walk-in shower with non-slip flooring.',
  },
  {
    icon: <MapPin className="w-5 h-5 text-[#001F3D]/50" />,
    title: 'Convenience',
    desc: 'Situated on the ground level for easy access to the lobby, banquet halls, and swimming pool.',
  },
];
    ...
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      <section className="relative h-[55vh] min-h-[420px] w-full overflow-hidden flex items-center justify-center text-white">
        <div className="absolute inset-0 z-0">
          <Image
            src="/MInds Photos/MINDS to send/X11.jpg"
            alt="Suite Room"
            fill
            priority
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <span className="text-[10px] uppercase tracking-[0.5em] font-bold text-[#D4A044]">The Accessible Garden Sanctuary</span>
            <div className="h-[1px] w-10 bg-[#D4A044]" />
          </div>
          <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight">Suite Room</h1>
        </motion.div>
      </section>
          ...
          <div className="lg:col-span-2 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[#001F3D]/70 text-sm leading-relaxed">
                Located on the ground floor, the Suite Room is our most inclusive and private offering. It is designed specifically to provide maximum comfort with a seamless connection to our private gardens.
              </p>
            </div>
            ...
            >
              <div>
                ...
                <div className="flex items-baseline gap-1 mt-2">
                  <span className="text-3xl font-serif font-bold text-[#D4A044]">$300</span>
              ...
              <div className="flex flex-col gap-3 border-t border-gray-100 pt-4">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-bold text-[#001F3D]">756 sqft</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-[#001F3D]/60">View:</span>
                  <span className="font-bold text-[#1B4F8A]">Private Garden</span>
                </div>
              </div>
