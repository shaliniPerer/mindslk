    ...
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      <section className="relative h-screen w-full bg-[#001F3D] overflow-hidden flex items-center justify-center text-center text-white">
        ...
        <div className="absolute inset-0 z-0 opacity-40">
           <Image 
             src="https://picsum.photos/seed/minds-halls/1920/1080?blur=2" 
             alt="Halls & Venues"
             fill
        ...
        <div className="relative z-10 max-w-4xl px-6 flex flex-col items-center gap-8">
          ...
          >
            ...
            <span className="text-xs uppercase tracking-[0.4em] font-bold text-[#D4A044]">Halls & Venues</span>
            <div className="h-[1px] w-12 bg-[#D4A044]" />
          </motion.div>
          ...
          >
            We&apos;re preparing our stunning banquet halls for your special events. Our heritage venues will be available for booking very soon.
          </motion.p>
          ...
          >
            ...
            <Link href="/#contact" className="bg-[#D4A044] text-[#001F3D] px-10 py-4 rounded-full font-bold text-sm tracking-widest hover:bg-[#B38536] transition-all transform hover:scale-105 shadow-xl flex items-center gap-3">
              Contact Us for Inquiries <span className="text-lg">→</span>
            </Link>
          </motion.div>
        </div>
      </section>
